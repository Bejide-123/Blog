  ...
  const toggleLike = async (postId) => {
    ...
    try {
      ...
      setSavedPosts((prevPosts) =>
        prevPosts.map((post) =>
          post.id === postId ? { ...post, likescount: count || 0 } : post,
        ),
      );
    } catch (error) {
  ...
  const displayedPosts = savedPosts
    ...
    .sort((a, b) => {
      switch (sortBy) {
        ...
        case "oldest":
          return (
            new Date(a.saved_at || a.createdat) -
            new Date(b.saved_at || b.createdat)
          );
        default: // recent
          return (
            new Date(b.saved_at || b.createdat) -
        ...
        <div className="max-w-7xl mx-auto px-4 py-8 pb-28 md:pb-28 lg:pb-32">
          <div className="flex flex-col lg:grid lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3">
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      >
                        Saved Stories Options
                      </h3>
                      <p
                        className={`text-xs ${theme === "light" ? "text-gray-500" : "text-gray-400"}`}
                      >
                        {showFeedHeader
                          ? "Hide options and filters"
                          : "Show options and filters"}
                      </p>
                    </div>
                  </div>
                  <span
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  <div>
                    ...
                    >
                      Your personal collection • {displayedPosts.length}{" "}
                      {displayedPosts.length === 1 ? "story" : "stories"}
                    </p>
                  </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-6">
                  <div
                    className={`flex items-center gap-3 p-3 bg-gradient-to-r ${theme === "light" ? "from-blue-50 to-purple-50" : "from-blue-900/20 to-purple-900/20"} rounded-xl`}
                  >
                  ...
                  <div
                    className={`flex items-center gap-3 p-3 bg-gradient-to-r ${theme === "light" ? "from-green-50 to-emerald-50" : "from-green-900/20 to-emerald-900/20"} rounded-xl`}
                  >
                  ...
                  <div
                    className={`flex items-center gap-3 p-3 bg-gradient-to-r ${theme === "light" ? "from-orange-50 to-red-50" : "from-orange-900/20 to-red-900/20"} rounded-xl`}
                  >
                    ...
                    <div>
                      ...
                      >
                        {displayedPosts.reduce(
                          (total, post) => total + (post.read_time || 5),
                          0,
                        )}{" "}
                        min
                      </p>
              ...
              {showFilters && (
                <div
                  className={`relative ${theme === "light" ? "bg-white" : "bg-slate-800"} rounded-2xl border ${theme === "light" ? "border-gray-200" : "border-slate-700"} p-5 mb-8 shadow-lg`}
                >
                  ...
                  <div className="flex items-center gap-2 mb-4 flex-wrap">
                    ...
                    {sortOptions.map((option) => (
                      <button
                        ...
                        onClick={() => {
                          setSortBy(option.id);
                          // On mobile, close filters after selecting sort option
                  ...
                  {allTags.length > 0 && (
                    <div className="mb-4">
                      <p
                        className={`text-sm font-medium ${theme === "light" ? "text-gray-700" : "text-gray-300"} mb-3`}
                      >
                        Filter by topics:
                      </p>
                  ...
                  {selectedTags.length > 0 && (
                    <div className="flex flex-wrap gap-2">
                      {selectedTags.map((tag) => (
                        <span
                          key={tag}
                          className={`inline-flex items-center gap-1 px-3 py-1.5 bg-gradient-to-r ${theme === "light" ? "from-blue-100 to-purple-100 text-blue-700" : "from-blue-900/30 to-purple-900/30 text-blue-300"} rounded-lg text-sm`}
                        >
                          #{tag}
                          <button
                            onClick={() => toggleTag(tag)}
              ...
              <div className="space-y-6">
                {displayedPosts.length === 0 ? (
                  ...
                  >
                    <div
                      className={`w-24 h-24 mx-auto mb-6 bg-gradient-to-r ${theme === "light" ? "from-blue-100 to-purple-100" : "from-blue-900/30 to-purple-900/30"} rounded-full flex items-center justify-center`}
                    >
                      <Bookmark
                        className={`w-12 h-12 ${theme === "light" ? "text-blue-600" : "text-blue-500"} fill-current`}
                      />
                    </div>
                    <h3
                      className={`text-2xl font-bold ${theme === "light" ? "text-gray-900" : "text-white"} mb-3`}
                    >
                      No saved stories yet
                    </h3>
                    <p
                      className={`${theme === "light" ? "text-gray-600" : "text-gray-400"} mb-8 max-w-md mx-auto`}
                    >
                      When you find stories you want to read later, click the
                  ...
                  displayedPosts.map((post) => {
                    ...
                    const isFollowing = followedUsers.has(
                          ...
                          <div className="flex items-start justify-between mb-4 gap-3">
                            ...
                            <div className="flex items-center gap-2 flex-shrink-0">
                              ...
                              <div className="relative">
                                ...
                                {isMenuOpen && (
                                  <div
                                    className={`absolute right-0 mt-2 w-56 ${theme === "light" ? "bg-white" : "bg-slate-800"} rounded-xl shadow-2xl border ${theme === "light" ? "border-gray-200" : "border-slate-700"} py-2 z-50`}
                                  >
                                    <button
                                      onClick={(e) => {
                                        e.stopPropagation();
                                    ...
                                    <div
                                      className={`border-t ${theme === "light" ? "border-gray-200" : "border-slate-700"} my-1`}
                                    ></div>
                                    <button
                                      className={`w-full px-4 py-2.5 text-left flex items-center gap-3 ${theme === "light" ? "hover:bg-gray-50 text-red-600" : "hover:bg-slate-700 text-red-500"} transition-colors`}
                                    >
                          ...
                          >
                            ...
                            <div className="flex items-center gap-1 sm:gap-2">
                              ...
                              <button
                                ...
                                disabled={!user?.id}
                                className={`p-1.5 sm:p-2 rounded-lg transition-all duration-300 ${`bg-gradient-to-r ${theme === "light" ? "from-yellow-50 to-amber-50 text-yellow-600" : "from-yellow-900/20 to-amber-900/20 text-yellow-400"}`} ${!user?.id ? "opacity-50 cursor-not-allowed" : ""}`}
            ...
            <div
              className={`lg:col-span-1 space-y-6 ${showTrendingSidebar ? "block" : "hidden"} lg:block`}
            >
              {/* Trending Topics */}
              <div
              ...
              <PostImageModal
                ...
                theme={theme}
                isLiked={
                  imageModalPost ? likedPosts.has(imageModalPost.id) : false
                }
                isSaved={
                  imageModalPost
                    ? savedPosts.some((post) => post.id === imageModalPost.id)
                    : false
                }
              />
            </div>
