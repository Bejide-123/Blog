          ...
          <div className="min-h-screen bg-gradient-to-b from-gray-50 via-white to-white dark:from-slate-900 dark:via-slate-900 dark:to-slate-950 pt-16 md:pt-20">
            <div className="max-w-7xl mx-auto px-4 py-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8">
                {/* Total Posts */}
                <div className="group relative bg-white dark:bg-slate-800 rounded-2xl border border-gray-200 dark:border-slate-700 p-6 shadow-lg hover:shadow-2xl dark:hover:shadow-slate-900/50 transition-all duration-300 hover:-translate-y-1">
                  ...
                  {stats.drafts > 0 && (
                    <div className="mt-3 flex items-center gap-2 text-sm text-orange-600 dark:text-orange-400 font-medium">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                {/* Top Performing Post */}
                <div className="lg:col-span-2 group relative bg-white dark:bg-slate-800 rounded-2xl border border-gray-200 dark:border-slate-700 shadow-lg hover:shadow-2xl dark:hover:shadow-slate-900/50 transition-all duration-300 overflow-hidden">
                  ...
                  <div className="p-6">
                    ...
                    <div className="bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/10 dark:to-orange-900/10 rounded-xl p-5 border border-yellow-200 dark:border-yellow-900/30">
                      ...
                      <div className="flex flex-wrap gap-2 mb-4">
                        {topPost.tags.map((tag, index) => (
                          <span
                            key={index}
                            className="px-3 py-1 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 text-blue-700 dark:text-blue-400 text-xs font-medium rounded-full"
                          >
                            #{tag}
                          </span>
                        ))}
                      ...
                      <div className="mt-4 pt-3 border-t border-yellow-200 dark:border-yellow-900/30">
                ...
                {/* Recent Activity */}
                <div className="group relative bg-white dark:bg-slate-800 rounded-2xl border border-gray-200 dark:border-slate-700 shadow-lg hover:shadow-2xl dark:hover:shadow-slate-900/50 transition-all duration-300 overflow-hidden">
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="space-y-4">
                      {recentActivity.map((activity, index) => (
                        <div
                          key={index}
                          className="flex items-center gap-3 p-3 rounded-xl hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-all duration-200 group/item"
                        >
                          <img
                            src={activity.avatar}
                            alt={activity.user}
              ...
              <div className="flex flex-wrap gap-3 mb-8">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-3 bg-white dark:bg-slate-800 text-gray-700 dark:text-gray-300 font-semibold rounded-xl border border-gray-300 dark:border-slate-600 hover:border-blue-600 dark:hover:border-blue-500 hover:text-blue-600 dark:hover:text-blue-500 transition-all duration-300 hover:bg-gray-50 dark:hover:bg-slate-700"
                >
                ...
                {stats.drafts > 0 && (
                  <button
                    onClick={() => navigate("/create")}
                    className="flex items-center gap-2 px-6 py-3 bg-white dark:bg-slate-800 text-gray-700 dark:text-gray-300 font-semibold rounded-xl border border-orange-300 dark:border-orange-600 hover:border-orange-500 dark:hover:border-orange-500 hover:text-orange-600 dark:hover:text-orange-500 transition-all duration-300 hover:bg-orange-50 dark:hover:bg-orange-900/20"
                  >
                    <FileText className="w-5 h-5" />
                    Manage Drafts ({stats.drafts})
                  </button>
                )}
                <button className="flex items-center gap-2 px-6 py-3 bg-white dark:bg-slate-800 text-gray-700 dark:text-gray-300 font-semibold rounded-xl border border-gray-300 dark:border-slate-600 hover:border-green-600 dark:hover:border-green-500 hover:text-green-600 dark:hover:text-green-500 transition-all duration-300 hover:bg-gray-50 dark:hover:bg-slate-700">
              ...
              <div className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-200 dark:border-slate-700 shadow-lg overflow-hidden">
                            ...
                            <div className="flex items-center gap-3">
                              <div className="flex-1 min-w-0">
                                <button
                                  ...
                                  className="text-gray-900 dark:text-white font-medium hover:text-blue-600 dark:hover:text-blue-500 transition-colors text-left block truncate"
                                >
                                  {post.title}
                                </button>
                                {post.trending && (
                                  <span className="inline-flex items-center gap-1 px-2 py-1 bg-gradient-to-r from-red-500/10 to-pink-500/10 text-red-600 dark:text-red-400 text-xs font-semibold rounded-full mt-1">
                                    <TrendingUp className="w-3 h-3" />
                                    Trending
                                  </span>
                                )}
                          ...
                          <td className="px-6 py-4 text-right">
                            <div className="flex items-center justify-end gap-1">
                              ...
                              <button
                                ...
                                className="p-2 text-gray-600 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-xl transition-all duration-300"
                                title="Delete post"
                              >
                ...
                <div className="md:hidden">
                  {recentPosts.map((post) => (
                    <div
                      key={post.id}
                      className="p-4 border-b border-gray-200 dark:border-slate-700 last:border-0"
                    >
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex-1 min-w-0">
                          <button
                            onClick={() => handleViewPost(post.id)}
                            className="text-base font-semibold text-gray-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-500 transition-colors mb-1 text-left block truncate"
                          >
                            {post.title}
                          </button>
                          {post.trending && (
                            <span className="inline-flex items-center gap-1 px-2 py-1 bg-gradient-to-r from-red-500/10 to-pink-500/10 text-red-600 dark:text-red-400 text-xs font-semibold rounded-full">
                              <TrendingUp className="w-3 h-3" />
                              Trending
                            </span>
                          )}
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          onClick={() => handleViewPost(post.id)}
                          className="flex-1 px-3 py-2 text-sm text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-slate-700 rounded-lg hover:bg-gray-200 dark:hover:bg-slate-600 transition-colors font-medium flex items-center justify-center gap-1"
                        >
                          <Eye className="w-4 h-4" />
                          View
                        </button>
                        <button
                          onClick={() => handleEditPost(post.id)}
                          className="flex-1 px-3 py-2 text-sm text-blue-600 dark:text-blue-500 bg-blue-50 dark:bg-blue-900/20 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors font-medium flex items-center justify-center gap-1"
                        >
                          <Edit className="w-4 h-4" />
                          Edit
                        </button>
                        <button
                          onClick={() => handleDeletePost(post.id)}
                          className="px-3 py-2 text-sm text-red-600 dark:text-red-500 bg-red-50 dark:bg-red-900/20 rounded-lg hover:bg-red-100 dark:hover:bg-red-900/30 transition-colors flex items-center justify-center"
                        >
                          <Trash2 className="w-4 h-4" />
                        </button>
                      </div>
