        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-10">
              <button onClick={() => handleNavClick('/feed')} className="group flex items-center gap-2">
          ...
          {navItems.map(({ path, icon: Icon, label, isCenter, badge }) => (
            <button
              ...
              className={`relative flex flex-col items-center justify-center transition-all ${
                ...
                isActive(path) && !isCenter ? 'text-blue-600 dark:text-blue-500' : 'text-slate-600 dark:text-slate-400'
              }`}
            >
